Feature: Search for flights by route and date
    ...
    Scenario: Search for flights by route and date with valid results
        Given the following flights exist:
            ...
            | EA124        | YVR                      | America/Vancouver        | CDG                        | Europe/Paris               | 2026-01-01T14:00:00 | 2026-01-02T09:00:00 | 1200.00      | 4500.00       |
            | EA125        | YVR                      | America/Vancouver        | LHR                        | Europe/London              | 2026-01-01T09:00:00 | 2026-01-02T04:00:00 | 1000.00      | 4000.00       |
        When I search for flights from YVR to CDG on 2026-01-01
        Then the following flights are returned:
            ...
            | EA123        | YVR                      | America/Vancouver        | CDG                        | Europe/Paris               | 2026-01-01T10:00:00 | 2026-01-02T05:00:00 | 1200.00              | 4500.00               | 301                   | 36                     |
            | EA124        | YVR                      | America/Vancouver        | CDG                        | Europe/Paris               | 2026-01-01T14:00:00 | 2026-01-02T09:00:00 | 1200.00              | 4500.00               | 301                   | 36                     |

    Scenario: No flights available for the given route and date
        Given the following flights exist:
            | FlightNumber | DepartureAirportIataCode | DepartureAirportTimeZone | DestinationAirportIataCode | DestinationAirportTimeZone | DepartureTime       | ArrivalTime         | EconomyPrice | BusinessPrice |
            | EA123        | YVR                      | America/Vancouver        | CDG                        | Europe/Paris               | 2026-01-02T10:00:00 | 2026-01-03T05:00:00 | 1200.00      | 4500.00       |
        When I search for flights from YVR to CDG on 2026-01-01
    ...
    Scenario: Search for flights with no matching route
        Given the following flights exist:
            | FlightNumber | DepartureAirportIataCode | DepartureAirportTimeZone | DestinationAirportIataCode | DestinationAirportTimeZone | DepartureTime       | ArrivalTime         | EconomyPrice | BusinessPrice |
            | EA123        | YVR                      | America/Vancouver        | LHR                        | Europe/London              | 2026-01-01T10:00:00 | 2026-01-02T05:00:00 | 1000.00      | 4000.00       |
        When I search for flights from YVR to CDG on 2026-01-01
        Then no flights are returned

    Scenario: Search with invalid date format
        When I search for flights from YVR to CDG on 2026-01-100
    ...
    Scenario: Search with missing departure airport code
        When I search for flights from  to CDG on 2026-01-01
    ...
    Scenario: Search with missing destination airport code
        When I search for flights from YVR to  on 2026-01-01
    ...
    Scenario: Search with the same departure and destination airports
        When I search for flights from YVR to YVR on 2026-01-01
