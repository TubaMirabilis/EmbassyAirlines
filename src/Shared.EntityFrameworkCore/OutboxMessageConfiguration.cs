...
public sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> builder)
    {
        ...
        builder.Property(o => o.Name).IsRequired().IsUnicode(false).HasMaxLength(256);
        builder.Property(o => o.Content).IsRequired();
        builder.Property(o => o.CreatedOnUtc).HasColumnType("timestamp with time zone").IsRequired();
        builder.Property(o => o.ProcessedOnUtc).HasColumnType("timestamp with time zone").IsRequired(false);
